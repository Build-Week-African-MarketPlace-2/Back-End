...
exports.seed = function(knex) {
  ...
  .then(function(){
    ...
    {name: 'Kiondo Bag', description: "Different colors hand made", price: 5, location: "Sawa Sawa", category: "Accesories", user_id: 3},
    {name: 'Horned Melon', description: "seed testing data", price: 7, location: "Kalahari", category: "Fruits", user_id: 4},
